...
def make(file):
    with open(file, "r") as f, open(file + ".py", "w") as f2:
        f2.write("""from __future__ import annotations
...
from ..models import UidStructure, UidNameStructure, ValueDescriptor, SubjectDescriptor\n""")
        for i in f.readlines():
            ...
            f2.write(f"    {v[1]}: {a} = Field(alias=\"{v[0]}\", frozen=True)\n")

make(R"C:\Users\vajkh\OneDrive\Desktop\e-kreta-hun0r-2.0\utils\api_models_source")